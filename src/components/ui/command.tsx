...
const CommandDialog = ({ children, ...props }: DialogProps) => {
  return (
    <Dialog {...props}>
      <DialogContent className="explita-command-dialog">
        <Command className="explita-command">{children}</Command>
      </DialogContent>
    </Dialog>
  );
};
...
>(({ className, ...props }, ref) => (
  <div className="explita-command-input-wrapper" cmdk-input-wrapper="">
    <LuSearch />
...
>((props, ref) => (
  <CommandPrimitive.Empty
    ref={ref}
    className="explita-command-empty"
    {...props}
  />
));
